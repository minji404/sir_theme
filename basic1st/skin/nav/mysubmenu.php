<style TYPE="text/css">
<!--
	#mysubmenu{width: 100%;height: 50px;margin: 0 auto;display: none;}
	#snb > li.snb{width:100%;display:none;}
	#snb > li.snb.active{display:block !important;}
	#snb .snb2dul > li.active{background: #f00;width:200px;}
	#snb .snb2dul{margin: 0 auto;width: 100%;height: 50px;display: none; }
	#snb .snb2dul>li{float: left;width:200px;background-color:gray;}
	#snb .snb2dul>li>a{display: block;line-height: 50px;text-align: center;}
	#snb .snb2dul>li:after{content:"";display: block;clear:both;}
//-->
</style>
